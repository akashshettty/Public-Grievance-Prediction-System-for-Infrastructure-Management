                ...
                {filter.type === 'date' && (
                  <div className="flex flex-col gap-3">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2 bg-white text-black font-semibold rounded-lg hover:shadow-glow transition-all duration-300"
                    >
                      Apply Date Filter
                    </button>
                  </div>
                ...
                {filter.type === 'slider' && filter.min !== undefined && filter.max !== undefined && (
                  <div className="space-y-4">
                    ...
                    <div className="text-sm text-gray-300">
                      Level: {filter.value} (Range: {filter.min} - {filter.max})
                    </div>
                  </div>
                )}
              </div>
